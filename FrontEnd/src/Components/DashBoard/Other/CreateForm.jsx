                        ...
                        <div className="row mb-3">
                            <div className="col-md-6 mb-4">
                                <div className="form-floating mb-3 mb-md-0">
                                    <input className="form-control" id="username" name="username" type="text" placeholder="Enter your username" />
                            ...
                            <div className="col-md-6 mb-4">
                                <div className="form-floating mb-3 mb-md-0">
                                    <input className="form-control" id="password" name="password" type="text" placeholder="Enter your password" />
                            ...
                            <div className="col-md-6 mb-4">
                                <div className="form-floating mb-3 mb-md-0">
                                    <input className="form-control" id="fullname" name="fullname" type="text" placeholder="Enter your firstname" />
                            ...
                            <div className="col-md-6 mb-4">
                                <div className="form-floating mb-3 mb-md-0">
                                    <input className="form-control" id="address" name="address" type="text" placeholder="Enter your address" />
                            ...
                            <div className="col-md-6 mb-4">
                                <div className="form-floating mb-3 mb-md-0">
                                    <input className="form-control" id="email" name="email" type="text" placeholder="Enter your email" />
                            ...
                            <div className="col-md-6 mb-4">
                                <div className="form-floating mb-3 mb-md-0">
                                    <input className="form-control" id="phone" name="phone" type="text" placeholder="Enter your phone" />
                            ...
                            <div className="col-md-6 mb-4">
                                <div className="preview mb-4">
                                    <img width="100%" height="400px" src="" alt="" id="img" />
                                </div>
                                <div className="input-group">
                                    <input type="file" className="form-control" id="file" aria-describedby="image_button" aria-label="Upload" />
                                    <button className="btn btn-outline-secondary" type="button" id="image_button">Upload</button>
                                    <input className="form-control d-none" id="images" name="images" type="text" placeholder="Enter your phone" />
                                </div>
                            </div>
                        </div>
